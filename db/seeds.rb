...
article = Article.create({
  ...
  image: 'https://www.thespruceeats.com/thmb/DVNRYj_l3s2ZogwY9ZVB4IooPHg=/1879x1409/smart/filters:no_upscale()/Headsofgreencabbage-5bfda38346e0fb00264606e3.jpg',
  category_ids: [1],
  author_id: user.id
})
